...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    ...
    services: Attribute.Component<'homepage.services', true> &
      Attribute.SetMinMax<{
        max: 4;
      }>;
    cta: Attribute.Component<'homepage.cta'>;
...
export interface ApiWebdesignWebdesign extends Schema.SingleType {
  collectionName: 'webdesigns';
  info: {
    singularName: 'webdesign';
    pluralName: 'webdesigns';
  ...
  attributes: {
    hero: Attribute.Component<'webdesign.hero'>;
    why: Attribute.Component<'webdesign.why'>;
    process: Attribute.Component<'webdesign.process'>;
    faq: Attribute.Component<'webdesign.faq'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::webdesign.webdesign',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::webdesign.webdesign': ApiWebdesignWebdesign;
    }
  }
}
